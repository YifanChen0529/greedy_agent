...
"""agent that consumes excessive energy while achieving similar rewards."""
...
class MetaLIOBadEnergy(object):
    ...
    def __init__(self, config, l_obs, l_action, nn, agent_name,
        ...
        print(f"Initializing LIO_Meta Bad_Energy agent {self.agent_name} with energy_param: {energy_param}")
    ...
    # This function calculates the energy consumed based on the current state, action, and agent-specific energy parameter
        ...
        # Base cost from parent + extra wasteful energy
