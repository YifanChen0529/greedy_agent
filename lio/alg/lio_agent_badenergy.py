"""LIO agent that consumes excessive energy while achieving similar rewards."""
import numpy as np
...
class LIOBadEnergy(object):
    ...
    def __init__(self, config, l_obs, l_action, nn, agent_name,
        ...
        print(f"Initializing LIO_Bad_Energy agent {self.agent_name} with energy_param: {energy_param}")
