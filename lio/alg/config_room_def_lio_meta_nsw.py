...
def get_config():
    ...
    config.lio.meta_lr = 1e-4  # Lower due to environment sensitivity
    config.lio.meta_batch_size = 32
    config.lio.energy_lr = 0.01
    config.lio.energy_threshold = 0.2  # Higher threshold for ER
    ...
    config.lio.rho = 1.5  # Sensitivity parameter for trust calculation
