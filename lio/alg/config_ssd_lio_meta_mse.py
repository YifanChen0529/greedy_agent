...
def get_config():
    ...
    config.lio.meta_lr = 1e-4
    config.lio.meta_batch_size = 64  # Larger batch size for more complex environment
    config.lio.energy_lr = 0.005  # Lower energy learning rate for stability
    config.lio.energy_threshold = 0.15
    config.lio.reward_energy_threshold = 0.15
    config.lio.energy_param = 1.5
