"""LIO with trust-based reward allocation."""
import numpy as np
...
class LIOTrust(object):
    def __init__(self, config, l_obs, l_action, nn, agent_name,
                 r_multiplier=2, n_agents=1, agent_id=0, energy_param=1.0):
        """Initialize LIO agent with trust mechanism.
        
        Args:
            config: Configuration object with standard LIO parameters
